"""Modification of `model.py` to incorporate effect of temperature of outer softmax layers."""
import logging
...
class TemperatureModel():
    ...
    def __init__(self, args, batch_size, mode='train'):
        ...
        # Extract the model's temperature from args
        self.T = args.T
        ...
        self.probs = tf.nn.softmax(self.logits/self.T)
